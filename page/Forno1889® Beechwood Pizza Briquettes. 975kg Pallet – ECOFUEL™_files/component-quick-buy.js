...
Line 51:1 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 52:13 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 58:6 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 67:5 Transforming const to the configured target environment ("es5") is not supported yet
Line 75:7 Transforming const to the configured target environment ("es5") is not supported yet
Line 79:7 Transforming const to the configured target environment ("es5") is not supported yet
Line 104:8 Transforming const to the configured target environment ("es5") is not supported yet
