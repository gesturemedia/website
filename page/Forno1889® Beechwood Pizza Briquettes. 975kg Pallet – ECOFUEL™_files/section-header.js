...
Line 25:7 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
...
Line 114:5 Transforming const to the configured target environment ("es5") is not supported yet
Line 155:3 Transforming const to the configured target environment ("es5") is not supported yet
Line 192:3 Transforming const to the configured target environment ("es5") is not supported yet
