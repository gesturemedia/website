...
Line 56:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 70:17 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 79:14 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 142:8 Transforming let to the configured target environment ("es5") is not supported yet
Line 201:14 Transforming const to the configured target environment ("es5") is not supported yet
Line 202:14 Transforming const to the configured target environment ("es5") is not supported yet
Line 203:14 Transforming const to the configured target environment ("es5") is not supported yet
Line 203:46 Transforming rest arguments to the configured target environment ("es5") is not supported yet
