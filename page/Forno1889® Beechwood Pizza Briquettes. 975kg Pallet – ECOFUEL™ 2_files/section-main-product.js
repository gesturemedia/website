...
Line 90:5 Transforming const to the configured target environment ("es5") is not supported yet
Line 91:5 Transforming const to the configured target environment ("es5") is not supported yet
Line 93:6 Transforming const to the configured target environment ("es5") is not supported yet
Line 95:7 Transforming const to the configured target environment ("es5") is not supported yet
Line 118:4 Transforming let to the configured target environment ("es5") is not supported yet
Line 145:3 Transforming const to the configured target environment ("es5") is not supported yet
Line 153:3 Transforming const to the configured target environment ("es5") is not supported yet
