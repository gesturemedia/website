...
Line 43:21 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
...
Line 67:8 Transforming let to the configured target environment ("es5") is not supported yet
Line 100:2 Transforming class syntax to the configured target environment ("es5") is not supported yet
