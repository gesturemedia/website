...
Line 18:1 Transforming class syntax to the configured target environment ("es5") is not supported yet
...
Line 43:3 Transforming let to the configured target environment ("es5") is not supported yet
Line 49:5 Transforming const to the configured target environment ("es5") is not supported yet
Line 53:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 96:17 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 135:15 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 159:16 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 167:13 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
