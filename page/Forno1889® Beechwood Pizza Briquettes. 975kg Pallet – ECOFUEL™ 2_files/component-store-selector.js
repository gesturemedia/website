...
Line 34:6 Transforming let to the configured target environment ("es5") is not supported yet
Line 39:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 60:10 Transforming const to the configured target environment ("es5") is not supported yet
Line 67:12 Transforming const to the configured target environment ("es5") is not supported yet
Line 84:10 Transforming const to the configured target environment ("es5") is not supported yet
